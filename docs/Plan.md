...
## Предусловие выполнения сценария:
    1. Скачать проект с [Github]_(https://github.com/artem4ik002/Diplom_qa) командой git clone
    2. Открыть проект в IntelliJ IDEA
    3. Запуcтить SUT (System Under Test) 
    4. Проверить доступность приложения, открыть страницу покупки тура http://localhost:8080 (ссылка перехода на страницу покупки тура доступна только при запущенной SUT).
    5. Проверить сценарии на вкладке "Купить", затем на вкладке "Купить в кредит".

## Валидными данными при заполнении полей формы считаются:
