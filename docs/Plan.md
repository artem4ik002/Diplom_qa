...
6. Проверить доступность приложения. - Открыть браузер, перейти по адресу:http://localhost:8080;
7. Проверить сценарии на вкладке "Купить", затем на вкладке "Купить в кредит".
